        ...
        {bookings.map((booking) => (
          ...
          >
            ...
            <div className='flex flex-col justify-center gap-3'>
              ...
              {!booking.isPaid && (
                <button onClick={() => handlePayment(booking._id)} className='px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded-full hover:bg-gray-400 transition-all cursor-pointer'>
                  Pay Now
                </button>
              )}
            </div>
